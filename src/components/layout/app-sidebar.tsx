...
const navItems = [
  { href: "/", label: "Colony Overview", icon: Activity },
  { href: "/agents", label: "Agent Registry", icon: Bot },
  { href: "/test-runs", label: "Test Run History", icon: FlaskConical },
  { href: "/edge-cases", label: "Edge Case Tracker", icon: AlertTriangle },
  { href: "/stability", label: "Stability Metrics", icon: TrendingUp },
  { href: "/reports", label: "Integrity Reports", icon: FileCheck },
];
